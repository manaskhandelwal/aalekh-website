...
const sheetVariants = cva(
  "fixed z-[9999] gap-4 bg-zinc-300 px-16 py-8 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
        top: "inset-x-0 top-0 border-b w-full data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top",
        bottom:
          "inset-x-0 bottom-0 border-t w-full data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom",
...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps
>(({ side = "right", width, height, className, children, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay />
